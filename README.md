...
| :---:           | :---                                       | :---: |
|  _Questions_    | (#1) Évolution du code légataire           | 4/5   |
|                 | (#2) Analyse des défauts du code légataire | 9/10  |
|                 | (#3) Justification des choix de conception | 13/15   
|                 | (#4) Évolution du code objet               | 4/5   |
|  _Modèles_      | Justesse & Pertinence de la conception     | 13/15 |
|                 | Cohérence inter-modèles                    | 5/5   |
|                 | Respect des principes de conception        | 13/15 |
